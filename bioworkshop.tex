...
Aslak Tveito \\ Mattia Gazzola}{09.30}
\eventblock{red}{below= of SessionOne}{BreakOne}{Break with coffee and softdrinks}{10.45}
\eventblock{blue}{below= of BreakOne}{SessionTwo}{Margartia Staykova \\ Gladys Mass}{11.10}
\eventblock{red}{below= of SessionTwo}{Lunch}{Lunch}{12.00}
\eventblock{blue2}{below= of Lunch}{SessionThree}{Liesbeth Janssen \\ Irep G\"ozen \\ Yasmin Meroz \\ Cinzia Progida}{13.15}
\eventblock{red}{below= of SessionThree}{BreakTwo}{Break with coffee, s.d and fruits}{14.55}
\eventblock{blue}{below= of BreakTwo}{SessionFour}{Raymond Goldstein \\ Stig Ove Bøe \\ Guillaume Salbreux}{15.15}
...
\eventblock{blue2}{below= of Saturday}{SessionFive}{Marie Rognes \\ Alexandra Diem \\ M\'ar M\'asson \\ Federico Fenarillo}{09.00}
\eventblock{red}{below= of SessionFive}{BreakThree}{Break with coffee, croissants and softdrinks}{10.40}
\eventblock{blue}{below= of BreakThree}{SessionSix}{Klas Pettersen \\ Sylvie Lorthois \\ Paul Dommersnes}{11.10}
...
\begin{figure}[hh]
    \centering
    \href{https://www.google.com/maps/d/edit?hl=no&hl=no&mid=1q9FpcHekR77D16V4eefgqkybvNc&ll=59.91839077669053%2C10.758429782339476&z=15}{\includegraphics[width=0.75\linewidth, height=0.75\linewidth]{img/Oslo.png}}
    %\includegraphics[width=0.45\linewidth, height=0.45\linewidth]{img/hovedgard.jpg}
...
\begin{wrapfigure}[9]{R}{0.5\textwidth}
    ...
    \includegraphics[width=0.5\textwidth]{Vigelansparken.jpg}% 
...
\begin{wrapfigure}[10]{R}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{operahouse.jpg}% 
...
\overview{2D or not 2D: Dimensional and mechanical cues in cell migration.}{Cinzia Anita Maria Progida}{Associate Professor
...
\overview{Upside-Down and Inside-Out: The Biomechanics of Cell Sheet Folding}{Professor Raymond E. Goldstein}{}{Deformations of cell sheets are ubiquitous in early animal development,
...
\overview{Active matter from electro-hydrodynamically propelled particles}{Paul Dommersnes}{}{Insulating particles or drops suspended in a carrier liquid may start to rotate with a constant
...
These conjugates formed nanoparticle like structures in solution which targeted the endosomes. The
