...
contents={\begin{tikzpicture}[remember picture,overlay]
 \path [left color = red!35,middle color = red!25, right color = white] (current page.south west)rectangle (current page.north east);   % Adjust the position of the logo.
\end{tikzpicture}}
}
