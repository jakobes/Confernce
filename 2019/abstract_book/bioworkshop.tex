...
\eventblock{blue}{below= of Friday}{Registration}{Registration }{09.30}
\eventblock{red}{below= of Registration}{Opening}{Opening}{09.45}
\eventblock{blue}{below= of Opening}{SessionOne}{Paul Dommersnes\\
Amin Doostmohammadi}{S1 \\ 10.00}
\eventblock{red}{below= of SessionOne}{BreakOne}{Break}{10.50}
\eventblock{blue2}{below= of BreakOne}{SessionTwo}{Paolo Zunino\\ Alessandro Coclite\\Federico Fenarilo}{S2 \\ 11.10}
\eventblock{red}{below= of SessionTwo}{Lunch}{Lunch}{12.25}
\eventblock{blue2}{below= of Lunch}{SessionThree}{Jaques Prost\\Andreas Carlson\\Corinna Maa\ss}{S3 \\ 13.55}
\eventblock{red}{below= of SessionThree}{BreakTwo}{Break}{14.45}
\eventblock{blue2}{below= of BreakTwo}{SessionFour}{Kaare Hartvig-Jensen\\Hunter King\\Kent-Andre Mardal}{S4 \\ 15.05}
\eventblock{red}{below= of SessionFour}{Social}{Social gathering with snacks, beer and wine.}{16.20}
\eventblock{blue}{below= of Social}{Dinner}{Workshop dinner at \\ Solsiden}{19.00}
\eventblock{red}{right=2cm of Friday}{Saturday}{Program \\ Saturday August 31 }{}
\eventblock{blue2}{below= of Saturday}{SessionFive}{Jakob Schreiner\\ Vegard Vinje\\Alain Goriely }{S5 \\ 09.30}
\eventblock{red}{below= of SessionFive}{BreakThree}{Break with coffee, croissants and softdrinks}{  10.45}
\eventblock{blue2}{below= of BreakThree}{SessionSix}{Kartik Jain\\Susanne Liese\\Noemi Guadgno }{S6 \\ 11.05}
\eventblock{red}{below= of SessionSix}{LunchTwo}{Lunch}{12.20}
...
\noindent 1-5, go to Tøyen from Jernbanetorget in the eastward direction. \textbf{To get from
...
% \section*{Grünerløkka}
% Through Oslo, from north to south, runs the river Akerselva. Along the river there are
% parklands and walking trails, but also remains of Oslo’s industrial history.
% Grünerløkka lies on the east side of the river, behind the old industrial buildings. The
% former factory district turned fashion hub, with laid-back cafes and galleries galore,
% Grünerløkka is a colourful mix of old and new décor. Independent boutiques and design
% shops showcase Oslo’s more alternative side, with 19th-century buildings serving as a
