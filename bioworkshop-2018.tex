...
\eventblock{blue2}{below= of BreakOne}{SessionTwo}{Nir Gov \\ Roberto Mayor \\  Andrew Callan-Jones }{S2 \\ 11.10}
...
\eventblock{blue2}{below= of Saturday}{SessionFive}{ Karen Støverud \\ 
Federica Laurino \\ Lars Magnus Valnes }{S5 \\ 10.00}
\eventblock{red}{below= of SessionFive}{BreakThree}{Break with coffee, croissants and softdrinks}{  11.15}
\eventblock{blue}{below= of BreakThree}{SessionSix}{ Orit Peleg \\ Josip Augustin Jane\v{s} }{S6 \\ 11.40}
...
\overview{ \hspace{1.3cm}Tailored in vitro tissue models:  \newline Instrumentation \& 3D printing}{Johan Ulrik Lind }{Department of Micro- and Nanotechnology \\
...
\overview{\hspace{1.cm}
Rear supracellular contraction drives \newline collective cell chemotaxis}{Roberto Mayor}{Department of Cell and Developmental Biology \\ University College London }
{
...
\overview{Modelling the cerebral microvasculature across multiple length scales and multiple compartments}{Stephen Payne}{Department of Engineering Science \\ University of Oxford
}
{
...
}{$\sp{1}$PULS Group, Institut f\"{u}r Theoretische Physik and Cluster of Excellence: \\ Engineering of Advanced Materials,
